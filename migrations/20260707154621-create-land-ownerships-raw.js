...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.sequelize.query(
      `CREATE TABLE land_ownerships_raw (
        ...
        change_indicator char(1) DEFAULT NULL,
        createdAt datetime DEFAULT CURRENT_TIMESTAMP,        
        proprietor_uk_based boolean NOT NULL,
        PRIMARY KEY (id),        
        INDEX source_snapshot_date (source_snapshot_date),
        INDEX title_no (title_no(255))        
      ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`,
    );
  },

  async down(queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`DROP TABLE land_ownerships_raw`);
  },
};
